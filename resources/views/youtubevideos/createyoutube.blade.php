                    ...
                    <form action="{{ route('youtubevideo.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="embed_link" name="embed_link" 
                                class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('embed_link') border-red-500 @enderror" required></textarea>
                            @error('embed_link')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
