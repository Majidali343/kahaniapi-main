        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="p-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class=" text-gray-900">
                    ...
                    <form action="{{ route('kahaniupdate', ['id' => $kahani->kahani_id]) }}" method="POST" enctype="multipart/form-data">

                        @csrf
                        <!-- Title -->
                        <div class="mb-4">
                            <label for="title" class="block text-gray-700 font-medium mb-2">Title</label>
                            <input type="text" id="title" name="title" value="{{ $kahani->title }}"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" rows="4"
                                class="w-full px-4 py-2 border  rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('description') border-red-500 @enderror">{{ $kahani->description }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="Duration" name="Duration" value="{{ $kahani->Duration }}"
                        ...
                        <div class="mb-4">
                            ...
                            <select id="pg" name="pg" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('pg') border-red-500 @enderror" required>
                                ...
                                <option value="3" {{  $kahani->pg  == '3' ? 'selected' : '' }}>PG +3</option>
                                <option value="7" {{  $kahani->pg == '7' ? 'selected' : '' }}>PG +7</option>
                                <option value="10" {{  $kahani->pg == '10' ? 'selected' : '' }}>PG +10</option>
                            </select>
                            @error('pg')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-2 flex flex-col">
                            ...
                            <div class="py-4 px-4">
                                @if ($kahani->audio)
                                    <audio controls src={{  asset('/storage').'/'.$kahani->audio }}></audio>
                                @endif
                            </div>
                        </div>
                      {{-- video  --}}
                        <div class="mb-4">
                            ...
                            <div class="py-4 px-4">
                                @if ($kahani->video)
                                    <video height="500px" width="550px" controls>
                                        <source src="{{ asset('storage/' . $kahani->video) }}" type="video/mp4">
                        ...
                        <div class="mb-4 flex flex-col ">
                            <div>
                                <label for="image" class="block text-gray-700 font-medium mb-2">Image File</label>
                            ...
                            <div class="py-4 px-4">
                                @if ($kahani->image)
                                    <img height="100px" width="120px"class="rounded-full"
                                        src={{  asset('/storage').'/'.$kahani->image }} alt="{{ $kahani->title }}">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="mb-4 flex flex-col ">
                            ...
                            <div class="py-4 px-4">
                                @if ($kahani->thumbnail)
                                    <img height="100px" width="120px"class="rounded-full"
                                        src={{  asset('/storage').'/'.$kahani->thumbnail }} alt="{{ $kahani->title }}">
                                @endif
                            </div>
                        </div>
