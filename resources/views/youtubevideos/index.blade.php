    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="p-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <a type="button" class="buttonuser" href="{{ route('youtubevideo.create') }}">Add Video</a> 
                                    ...
                                    @foreach ($videos as $video)
                                        <tr
                                            ...
                                            <td class="px-6 py-4">
                                                ...
                                                <a href="{{ route('youtubevideo.find', $video->id) }}">
                                                    <span class="material-symbols-outlined">edit_square</span>
                                                </a>

                                                <a href="#"
                                                    onclick="event.preventDefault(); confirmDelete({{ $video->id }});">
                                                ...
                                                <form id="delete-form-{{ $video->id }}"
                                                    action="{{ route('youtubevideo.delete', $video->id) }}"
