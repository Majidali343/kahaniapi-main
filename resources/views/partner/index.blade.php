    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="p-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <a type="button" class="buttonuser" href="{{ route('partner.create') }}">Add Partner</a> 
                                ...
                                @if (isset($partners))
                                    ...
                                    @foreach ($partners as $partner)
                                        <tr
                                            ...
                                            <td class=" py-2">
                                                @if ($partner->logo)
                                                <a href="{{ asset('/storage') . '/' . $partner->logo }}"
                                                    target="_blank">
                                            ...
                                            <td class="px-6 py-4">
                                                ...
                                                <a href="#"
                                                    onclick="event.preventDefault(); confirmDelete({{ $partner->id }});">
